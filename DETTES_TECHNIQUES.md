...
### PATRIMOINE-B-ZONES-TIER2-FAVORABLE-001

**Statut :** Ouverte, priorité moyenne (PR B planifiée).

**Date :** 2026-05-20

**Description :** 8 sites Tier 2 favorables restent à transformer en zones polygonales (PR B B-ZONES) : `monte_cinto`, `monte_san_petrone`, `monte_stello`, `monte_d_oro`, `monte_renoso` (5 monts, tracé manuel rayon ~2-3 km autour du sommet) + `capu_rossu` (OSM relation 9376817, natural=cape) + `cap_corse_extreme_nord` / Capu Bianchi (tracé manuel pointe Barcaggio) + `lac_de_nino` (OSM way 28890021, lac + extension manuelle pozzines).

**Condition de déblocage :** PR B `feat/b-zones-tier2-8-sites`, à démarrer après merge en prod et validation Soleil de la PR A Tier 1.
