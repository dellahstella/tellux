...
anomalies géomagnétiques naturelles — le tout sur une carte interactive
avec un double indice de perturbation (humaine / naturelle) documenté et
...
Je cherche un retour d'usage de la part d'une association reconnue dans
le domaine CEM. Un test de 15 minutes sur votre territoire suffit.
...
Cliquez n'importe où sur la carte. Tellux calcule deux indices séparés : un score de perturbation humaine (antennes, lignes, courants) et un score d'activité naturelle (géologie, anomalies crustales). Les deux ne s'additionnent pas — un lieu peut être fortement perturbé par les réseaux humains sans être géologiquement actif, et inversement.
...
- **Perturbation humaine** (0–5) : mesure l'exposition estimée aux sources artificielles (antennes, lignes HT). Plus le score est élevé, plus les sources humaines sont proches et puissantes.
- **Activité naturelle** (0–5) : mesure l'intensité des phénomènes géophysiques locaux (anomalie magnétique crustale, substrat piézoélectrique, proximité de faille). Ce n'est pas une mesure de danger — c'est une signature géologique.

Les deux indices sont indépendants. Un score humain de 4 et un score naturel de 1 signifie : beaucoup de perturbation réseau, peu d'activité géologique locale.
