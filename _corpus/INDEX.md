...
**Tensions :**
1. ELF et leucémies infantiles — non résolue
...
- Dossier axes : [`axes/`](axes/) — fiches complètes par domaine
- Dossier tensions : [`tensions/`](tensions/) — fiches détaillées quand justifiées
- Dossier hypothèses : [`hypotheses/`](hypotheses/) — fiches de test et protocoles
- Templates : [`_templates/`](_templates/) — modèles pour futures contributions

---

**Note importante :** ce fichier INDEX.md doit être mis à jour à chaque ajout ou révision significative dans le corpus. Les dates, compteurs, et statuts ne restent corrects que s'ils sont maintenus activement.
