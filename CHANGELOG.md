...
- Conséquence éditoriale § 9.2 cadre-scientifique : la phrase suivante « Cette densité reste inférieure à celle des grandes agglomérations métropolitaines » perd son antécédent direct (la notion de densité site/km² n'est plus introduite). À reformuler dans un fix éditorial ultérieur — hors scope du présent passage chiffres.
