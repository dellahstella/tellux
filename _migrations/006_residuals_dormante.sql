...
--
-- Référence : conception interne du module d'auto-affinage.
...
COMMENT ON TABLE public.residuals IS
  'Auto-affinage du modele Tellux : ecart mesure - prediction par contribution. Migration dormante au moment de la creation (conception interne).';
