...
│       └── cartoradio_certified_corse.json       # mesures RF certifiées publiées par l'ANFR (Cartoradio) : 30 fiches d'origine (EXEM) + ingestion élargie, hors calibration
├── docs/
